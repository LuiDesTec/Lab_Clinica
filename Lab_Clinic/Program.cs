...
namespace Lab_Clinic
{
     class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("===========================Cadastrar Convênio=========================");
            var  convenios = new TipoDeRequisicao();
            convenios.AddConvenio( "Bradesco");
            convenios.AddConvenio( "Hapvida");
            convenios.AddConvenio( "SUS");
            convenios.AddConvenio( "UPA");
      
            Console.WriteLine("Quantos convenio contem na lista? " + convenios.Convenios.Count);
            Console.WriteLine();
            Console.WriteLine("===================Lista de Convênios Cadastrados====================");
            foreach(Convenio convenio in convenios.Convenios)
            {
                Console.WriteLine("Convênios cadastrados: " + convenio.Nome);
            }
